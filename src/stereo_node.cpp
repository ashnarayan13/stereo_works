...
int main(int argc, char **argv) {
  ...
  //left and right rectified images subscriber
	message_filters::Subscriber<Image> left_sub(nh, "kitti_stereo/left/image_rect", 1);
	message_filters::Subscriber<Image> right_sub(nh, "kitti_stereo/right/image_rect", 1);
